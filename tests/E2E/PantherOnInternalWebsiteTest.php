...
class PantherOnInternalWebsiteTest extends PantherTestCase
{
    /** @test */
    public function check_openEmr_demo_page(): void
    {
        self::markTestSkipped("Panther with php built-in web server crash... maybe it's my machine");
        $openEmrDemoPage = '/interface/login/login.php?site=default';
